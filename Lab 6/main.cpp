...
void TestTwo()
{
    ...
    shapes.push_back(new Cylinder(0, 0, 0));
    shapes.push_back(new Cylinder(0, 7.7, 8.8));
...
void RandomShapes(vector<Shape *> &shapes)
{
    ...
    for (int i = 0; i < shapeCount; i++)
    {
        ...
        if (shapeType == 4) shape = new Cylinder(0, rf, rf);
...
void Random3DShapes(vector<Shape3D *> &shapes)
{
    ...
    for (int i = 0; i < shapeCount; i++)
    {
        ...
        if (shapeType == 1) shape = new Cylinder(0, rf, rf);
